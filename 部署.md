...
```
    log-error=/bitnami/mysql/data/mysqld.log
    general_log_file=/bitnami/mysql/data/mysqld_general.log
    general_log=1
```
...
helm upgrade redis redis/redis/ --namespace test --create-namespace -f redis/values.yaml
...
```
kubectl -n test get pod|grep redis-lock
kubectl -n test logs -f --tail 300 redis-lock-node-0 sentinel
```
...
```
helm install redis redis/redis/ --namespace prod --create-namespace -f redis/values-prod.yaml
helm upgrade redis redis/redis/ --namespace prod --create-namespace -f redis/values-prod.yaml

helm uninstall redis --namespace prod
kubectl -n prod delete pvc redis-data-redis-node-0
```



```
kubectl -n prod get pod -o wide|grep redis
kubectl -n prod get pvc|grep redis
kubectl -n prod describe pod redis-node-0
kubectl -n prod logs -f --tail 300 redis-node-0
```
...
kubectl -n test describe pod redis-node-0
```
...
```
helm install redis redis/redis/ --namespace dev --create-namespace -f redis/values.yaml
helm upgrade redis redis/redis/ --namespace dev --create-namespace -f redis/values.yaml
helm uninstall redis-dev --namespace dev
```



```
kubectl -n dev get pod|grep redis
kubectl -n dev describe pod redis-node-0
kubectl -n dev logs -f --tail 300 redis-node-0
kubectl -n dev exec -it redis-node-0 -- bash
kubectl -n dev describe pod redis-node-0
```
...
helm upgrade rabbitmq rabbitmq/rabbitmq/ --namespace test --create-namespace -f rabbitmq/values.yaml

helm uninstall rabbitmq --namespace test
kubectl -n test delete pvc data-rabbitmq-0 data-rabbitmq-1 data-rabbitmq-2
```



```
helm install rabbitmq rabbitmq/rabbitmq/ --namespace prod --create-namespace -f rabbitmq/values-prod.yaml
helm upgrade rabbitmq rabbitmq/rabbitmq/ --namespace prod --create-namespace -f rabbitmq/values-prod.yaml
```
...
kubectl -n test logs -f --tail 300 rabbitmq-1
kubectl -n test logs -f --tail 300 rabbitmq-2
```
...
```
kubectl -n prod get pod -o wide|grep rabbitmq
kubectl -n prod describe pod rabbitmq-0
kubectl -n prod delete pod rabbitmq-0
kubectl -n prod logs -f --tail 300 rabbitmq-0
kubectl -n prod logs -f --tail 300 rabbitmq-1
kubectl -n prod logs -f --tail 300 rabbitmq-2
```
...
```
kubectl -n test get pvc|grep elasticsearch
kubectl -n test get pod|grep elasticsearch
kubectl -n test logs -f --tail 300 elasticsearch-0
kubectl -n test describe pod elasticsearch-0

kubectl -n test logs -f --tail 300 elasticsearch-2

kubectl -n test delete pod elasticsearch-0
kubectl -n test delete pvc elasticsearch-elasticsearch-0 elasticsearch-elasticsearch-1 elasticsearch-elasticsearch-2
kubectl -n test exec -it elasticsearch-0 -c init-file-permission -- sh
```



```
helm template --release-name elasticsearch --namespace prod --values ../values-prod.yaml --output-dir ../../manifest/ ./

helm install elasticsearch elasticsearch/elasticsearch/ --namespace prod --create-namespace -f elasticsearch/values-prod.yaml
helm upgrade elasticsearch elasticsearch/elasticsearch/ --namespace prod --create-namespace -f elasticsearch/values-prod.yaml
helm uninstall elasticsearch --namespace prod
```
