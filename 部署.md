...
```
helm install mysql mysql/mysql/ --namespace test-test --create-namespace -f mysql/values.yaml
helm uninstall mysql --namespace test-test
```

```
kubectl -n test-test get pod
kubectl -n test-test logs -f --tail 300 mysql-0 metrics
kubectl -n test-test edit pod mysql-0
```
