...
```
helm template --release-name nginx  --namespace test --values ../values.yaml --output-dir ../../manifest/ ./
```
...
kubectl -n nginx describe pod nginx-nginx-ingress-controller-rsv7c
kubectl -n nginx logs -f --tail 300 nginx-nginx-ingress-controller-rsv7c
```
