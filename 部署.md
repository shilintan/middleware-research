...
```
helm install redis-lock redis/redis/ --namespace test --create-namespace -f redis/values.yaml
helm upgrade redis-lock redis/redis/ --namespace test --create-namespace -f redis/values.yaml
helm uninstall redis-lock --namespace test
```
