...
```
kubectl apply -f xxljob/xxljob-dev.yaml
```
...
```
kubectl apply -f nacos/nacos-dev.yaml
```

```
namespace=dev

kubectl -n $namespace get pod|grep nacos
...
```
kubectl apply -f seata/seata-dev.yaml
```

```
namespace=dev

kubectl -n $namespace get pod|grep seata
kubectl -n $namespace get svc|grep seata
kubectl -n $namespace logs -f --tail 300 deploy/seata-server
kubectl -n $namespace delete pod seata-server-fdb796c79-lmwxz
kubectl -n $namespace exec -it seata-server-fdb796c79-6fgzm -- sh
```
