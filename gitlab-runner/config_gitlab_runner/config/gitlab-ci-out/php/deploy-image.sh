...
if [  "${CI_COMMIT_REF_NAME}" = "main" ]; then
    ...
    export template_ingress_domain_prefix=your-domain-name.com
    export template_rc_init_count=3
    ...
    export template_ingress_domain_prefix=local.your-domain-name.com
    export template_rc_init_count=1
else
  exit 1
fi
